...
from .views import TaskListView, task_create, task_delete, task_toggle, category_list, category_create, category_delete, subtask_create, subtask_toggle


urlpatterns = [
        #Tasks
    # path('cbv/', TaskListView.as_view(), name='tasks_list_cbv'),
